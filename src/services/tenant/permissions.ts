...
export const TENANT_ENDPOINT_PERMISSIONS: EndpointPermission[] = [
  ...
  },
  {
    ...
    allowedRoles: ["*"],
    tenantAllowed: true,
    notes: "Phase 2. Tenant-scoped: resolves via JWT → lease_tenants. Only LEASE-related docs. s3_key excluded.",
  },
  {
    ...
    allowedRoles: ["*"],
    tenantAllowed: true,
    notes: "TENANT ownership check via lease_tenants. Returns 404 for unowned docs.",
  },
  {
