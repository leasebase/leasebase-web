...
export function PriorityActions({ actions, loading = false, className = "" }: PriorityActionsProps) {
  ...
  return (
    <div className={`rounded-lg border border-slate-800 bg-slate-950/70 ${className}`} role="region" aria-label="Priority actions">
      <div className="border-b border-slate-800 px-4 py-3">
        <h2 className="text-sm font-semibold text-slate-100">Priority Actions</h2>
      </div>
